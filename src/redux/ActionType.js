...
export const AddNewTaskValue = "Add_New_Task";
...
export const ChangeStatusLogInValue = "Change_Status_LogIn";
export const ChangeStatusLogOutValue = "Change_Status_LogOut"; 